...
export function normalizeProduct(product) {
  ...
  return {
    ...
    moq: product.moq || pricing.b2b?.minimumOrderQuantity || 5,
    retailPrice: pricing.b2c?.price || product.retailPrice || 0,
    salePrice: pricing.b2c?.salePrice || product.salePrice || null,
    b2bBasePrice: pricing.b2b?.price || product.b2bBasePrice || null,
    specialBasePrice: pricing.special?.price || product.specialBasePrice || null,
    priceTiers: pricing.b2b?.tiers || product.tiers || product.priceTiers || [],
  };
}
